...
__BUILDTIME__="21/06/2020 15:41:39"
# debug mode
DEBUGMODE=False
...
if not os.path.exists( "%s/Logs/" % QtHelper.dirExec() ):
    os.makedirs( "%s/Logs" % QtHelper.dirExec() )
...
class SettingsPage(QWidget):
    ...
    def createWidgets(self):
        """
        """
        qcCredGroup = QGroupBox(self.tr("JIRA server credentials"))
        ...
        qcSvrGroup = QGroupBox(self.tr("JIRA server informations"))
